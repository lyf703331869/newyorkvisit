...
export const attractions: Attraction[] = [
  ...
  },
  {
    ...
    stay: "1-1.5 小时",
    bestTime: "傍晚",
    highlights: ["Chelsea Market 串联", "公共艺术", "Hudson Yards"],
    ticket: undefined,
    nearby: ["切尔西市集", "Little Island", "The Vessel"],
  },
  {
    name: "Chelsea Market",
    tagline: "旧工厂改建的美食市集",
    ...
    stay: "1 小时",
    bestTime: "午餐或下午茶",
    highlights: ["Lobster Place", "Artists & Fleas", "Nine Orchard"],
    ticket: undefined,
    nearby: ["High Line", "Meatpacking", "Whitney Museum"],
  },
  {
    name: "Grand Central Terminal",
    tagline: "拥有星空穹顶的纽约交通地标",
    tags: ["建筑", "雨天", "CityPASS"],
    stay: "45 分钟",
    bestTime: "上午 10:00 前",
    highlights: ["Whispering Gallery", "Apple Store", "地下美食广场"],
    ticket: { label: "语音导览", url: "https://www.grandcentralterminal.com" },
    nearby: ["纽约公共图书馆", "布莱恩公园", "Chrysler Building"],
  },
  {
